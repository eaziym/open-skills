...
export default function Notification() {
    ...
    return (
        <>
            {/* Notif icon with unread counter badge */}
            <button 
                onClick={handleClick} 
                className='relative text-gray-700 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-lg text-sm p-2.5 pt-3 mr-3'
            >
                <svg 
